...
public class JdkHandlerTest {
    ...
    public void test() {
        ...
        Object[] extParametersHexDump = new Object[]{hexDump};
        Object[] extParameters = new Object[]{"test1", "test2"};
        ...
        try {
            ...
            handler.publish(mkTLSLogRecord(Level.FINE, "TLS Debug", null, extParametersHexDump));
        ...
        verify(logger).debug("TLS Debug");
        verify(logger).debug("TLS Debug" + lineSeparator + hexDump);
    }
